...
export const taskListAction = createAction(
  "TASKLIST",
  function prepare(taskList) {
    return { payload: [...taskList] };
  }
);
export const taskSelectedAction = createAction(
  "TASKSELECTED",
  function prepare(taskSelected) {
    return { payload: taskSelected };
  }
);
export const fetchTaskListStartAction = createAction(
  "FETCH_TASKLIST_START",
  function prepare() {
    return { payload: "start" };
  }
);
export const fetchTaskListSuccessfulAction = createAction(
  "FETCH_TASKLIST_SUCCESSFUL",
  function prepare() {
    return { payload: "successfull" };
  }
);
export const fetchTaskListFailedAction = createAction(
  "FETCH_TASKLIST_FAILED",
  function prepare() {
